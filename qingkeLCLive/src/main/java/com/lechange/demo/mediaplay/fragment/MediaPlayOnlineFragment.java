...
import com.lechange.demo.JS_Bridge.ScaleCallback;
...
public class MediaPlayOnlineFragment extends MediaPlayFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		talk_text=(TextView) mView.findViewById(R.id.talk_text);
...
//				R.drawable.live_pic_talkback);
		...
		talk_text.setText(R.string.talk_on);
...
//		toast(R.string.video_monitor_media_talk_close);
		...
		talk_text.setText(R.string.talk_off);
