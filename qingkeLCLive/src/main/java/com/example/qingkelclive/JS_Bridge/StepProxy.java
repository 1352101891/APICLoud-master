...
import com.example.qingkelclive.business.util.PermissionHelper;
import com.example.qingkelclive.login.SplashActivity;
import com.example.qingkelclive.login.StepActivity;
import com.example.qingkelclive.mediaplay.fragment.MediaPlayOnlineFragment;
...
import static com.example.qingkelclive.JS_Bridge.constant.PREKEY;
import static com.example.qingkelclive.JS_Bridge.constant.SERVERURL;
import static com.example.qingkelclive.JS_Bridge.constant.URL;
...
//                    util.Toast(constant.LOGIN_SUCCESS,mActivity);
    ...
    public void CreateFloatView(int x,int y,int w,int h,String fixon,boolean fixed){
        ...
        RelativeLayout.LayoutParams containerLP = new RelativeLayout.LayoutParams(w, h-y);
    ...
    public void FixPosition(int x,int y,int mode){
        ...
        if (mode==Configuration.ORIENTATION_LANDSCAPE){
            containerLP = new RelativeLayout.LayoutParams( h,w);
        }else {
