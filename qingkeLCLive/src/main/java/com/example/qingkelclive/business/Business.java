package com.example.qingkelclive.business;

import android.os.Bundle;
import android.os.Handler;
import android.util.Log;

import com.example.qingkelclive.business.entity.AlarmMessageInfo;
...
import com.example.qingkelclive.business.util.OpenApiHelper;
...
//					 handler.obtainMessage(retObject.mErrorCode, ((AccessToken.Response)retObject.resp).data.accessToken).sendToTarget();
	...
	public void userlogin(final String phoneNumber, final Handler handler) {
		Log.e("Business","userlogin---"+mHost);
