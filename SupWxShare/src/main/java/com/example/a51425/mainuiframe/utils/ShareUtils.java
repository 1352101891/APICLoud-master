...
//            }
    ...
    public static List<String> get_AllAppNames(Context context) {
        PackageManager pm = context.getPackageManager();
        List<PackageInfo> list2 = pm.getInstalledPackages(8192);
        ...
        for(int i = 0; i < mApps.size(); ++i) {
            ...
            Log.i("AppUtils", "appLabel:" + appLabel + " ||  packagename:" + packagename + " ||  appname:" + appname);
        }
        return packagenames;
    }
    /**
    ...
    public static String[] shareWXReadyRx(String shareImage) {
        ...
        if (ps.contains(Constant.WEIXINAPPPACKAGEQQ)) {
            LogUtil.e("安装了QQ");
        ...
        } else if (ps.contains(Constant.WEIXINAPPPACKAGEUC)) {
            LogUtil.e("安装了uc");
        ...
        } else if (ps.contains(Constant.WEIXINAPPPACKAGEQQBROWSER)) {
        ...
        } else if (ps.contains(Constant.WEIXINAPPPACKAGENEWSTODAY)) {
...
//            return strings;
//        }
        else if (ps.contains(Constant.WEIXINAPPPACKAGESINA)) {
