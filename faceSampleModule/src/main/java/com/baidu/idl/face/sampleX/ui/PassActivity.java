package com.baidu.idl.face.sampleX.ui;
...
public class PassActivity extends BaseActivity implements ILivenessCallBack, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.baidu.idl.face.sampleX.R.layout.activity_pass);
        mContext = this;
        initView();
        initData();
    }
    ...
    private void initView() {
        mLableTxt = findViewById(com.baidu.idl.face.sampleX.R.id.title);
        mLableTxt.setText(com.baidu.idl.face.sampleX.R.string.pass_1_n);
        mCameraView = findViewById(com.baidu.idl.face.sampleX.R.id.layout_camera);
        mImageTrack = findViewById(com.baidu.idl.face.sampleX.R.id.image_track);
        // 计算并适配显示图像容器的宽高
        calculateCameraView();
        mImage = findViewById(com.baidu.idl.face.sampleX.R.id.image);
        mNickNameTv = findViewById(com.baidu.idl.face.sampleX.R.id.tv_nick_name);
        mSimilariryTv = findViewById(com.baidu.idl.face.sampleX.R.id.tv_similarity);
        mNumTv = findViewById(com.baidu.idl.face.sampleX.R.id.tv_num);
        mDetectTv = findViewById(com.baidu.idl.face.sampleX.R.id.tv_detect);
        mFeatureTv = findViewById(com.baidu.idl.face.sampleX.R.id.tv_feature);
        mLiveTv = findViewById(com.baidu.idl.face.sampleX.R.id.tv_live);
        mAllTv = findViewById(com.baidu.idl.face.sampleX.R.id.tv_all);

        mRgbCircleView = findViewById(com.baidu.idl.face.sampleX.R.id.circle_rgb_live);
        mNirCircleView = findViewById(com.baidu.idl.face.sampleX.R.id.circle_nir_live);
        mDepthCircleView = findViewById(com.baidu.idl.face.sampleX.R.id.circle_depth_live);

        mLayoutInfo = findViewById(com.baidu.idl.face.sampleX.R.id.layout_info);
        mLinearTime = findViewById(com.baidu.idl.face.sampleX.R.id.linear_time);
        mLinearUp = findViewById(com.baidu.idl.face.sampleX.R.id.linear_up);
        RelativeLayout relativeDown = findViewById(com.baidu.idl.face.sampleX.R.id.relative_down);
        RelativeLayout relativeUp = findViewById(com.baidu.idl.face.sampleX.R.id.relative_up);
            ...
            public void run() {
                ...
                if (livenessModel == null) {
                    ...
                    if (code == 0) {
                        ...
                        mImage.setImageResource(com.baidu.idl.face.sampleX.R.mipmap.preview_image_angle);
                    }
                }
            }
        });
    ...
    public void onClick(View view) {
        if (view.getId() == com.baidu.idl.face.sampleX.R.id.relative_down) {
            mLinearTime.setVisibility(View.GONE);
            mLinearUp.setVisibility(View.VISIBLE);
        }

        if (view.getId() == com.baidu.idl.face.sampleX.R.id.relative_up) {
