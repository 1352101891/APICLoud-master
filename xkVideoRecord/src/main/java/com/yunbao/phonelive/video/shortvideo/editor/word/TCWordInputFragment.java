package com.yunbao.phonelive.video.shortvideo.editor.word;
...
public class TCWordInputFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.input_iv_yellow) {
        ...
        } else if (i == R.id.input_iv_bg_red) {
        ...
        } else if (i == R.id.input_iv_bg_yellow) {
        ...
        } else if (i == R.id.input_iv_bg_blue) {
        ...
        } else if (i == R.id.input_iv_bg_green) {
