...
import com.yunbao.phonelive.video.shortvideo.choose.TCVideoChooseActivity;
...
public class TCVideoSettingActivity extends AbsActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.btn_ok && checkVideoPermission()) {

            getConfigData();
            startVideoRecordActivity();

        } else if (i == R.id.btn_choose && checkVideoPermission()) {
    ...
    public void onDataEvnet(CallbackBean bean){
        Log.e("TCVideoSettingActivity","CallbackBean"+bean.getKey());
        if (bean.getKey().equals("TCVideoSettingActivity")&& bean.isFinish()){
            Intent intent=new Intent();
            intent.putExtra("VideoInfo",bean.getVideoInfo());
            TCVideoSettingActivity.this.setResult(RESULT_OK,intent);
            this.finish();
        }
    }
}
