...
import com.yunbao.phonelive.video.shortvideo.editor.bgm.TCBGMEditView;
import com.yunbao.phonelive.video.shortvideo.editor.bgm.TCBGMInfo;
import com.yunbao.phonelive.video.shortvideo.editor.word.widget.TCWordEditView;
...
public class EditPannel extends LinearLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        mBgmBtn = (ImageButton) view.findViewById(R.id.btn_music_1);
