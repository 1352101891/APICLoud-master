...
import com.yunbao.phonelive.video.shortvideo.editor.word.widget.FloatTextProgressBar;
import com.yunbao.phonelive.video.shortvideo.editor.word.widget.RangeSeekBar;
import com.yunbao.phonelive.video.shortvideo.editor.word.widget.TCOperationViewGroup;
import com.yunbao.phonelive.video.shortvideo.editor.word.widget.TCWordOperationView;
...
//                mTXVideoEditer.setTXVideoPreviewListener(null);
        ...
        } else if (i == R.id.btn_play) {//将选中的去掉
